...
@section('content')
    ...
    <nav class="w3-sidenav w3-collapse w3-white w3-animate-left w3-card-2" style="z-index:3;width:320px;"
        ...
        <a href="javascript:void(0)" class="w3-dark-grey w3-button w3-hover-black w3-left-align"
           onclick="document.getElementById('id01').style.display='block'">New Message <i
                    class="w3-padding-left fa fa-pencil"></i></a>
        <div>
            <a id="myBtn" onclick="myFunc('Demo1')" href="javascript:void(0)"><i
                        class="fa fa-inbox w3-padding-right"></i>Inbox (3)<i
                        class="w3-padding-left fa fa-caret-down"></i></a>
            ...
            <div class="w3-panel">
               <form action="#" method="post" >
                   ...
                   <div class="w3-section">
                       ...
                       <input type="submit" name="zapazi" class="w3-button w3-right">
                   </div>
               </form>
            </div>
        </div>
    ...
    <div class="w3-main" style="margin-left:320px;">
        ...
        <div id="Borge" class="w3-container person">
            <br>
            <img class="w3-round  w3-animate-top" src="{{ URL::asset('public/img/asd.jpg') }}" style="width:20%;">
